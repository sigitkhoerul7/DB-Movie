...
import sigit.dbmovieretofitcardview.adapter.MovieAdapterPlaying;
...
public class NowPlayingFragment extends Fragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void InitView(View view){
        ...
        recyclerView.addItemDecoration(new NowPlayingFragment.GridSpacingItemDecoration(2, dpToPx(10), true));
        recyclerView.setItemAnimator(new DefaultItemAnimator());
    ...
    private void fetch(boolean get){
        if(get){
            ...
            Call<NowPlaying> call = apiService.getNowPlaying(API_KEY);
            call.enqueue(new Callback<NowPlaying>() {
                ...
                public void onResponse(Call<NowPlaying> call, Response<NowPlaying> response) {
                    ...
                    recyclerView.setAdapter(new MovieAdapterPlaying(result,getActivity().getApplicationContext()));
                }
